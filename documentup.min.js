this.DocumentUp = {}, DocumentUp.document = function(a) {
  ...
  c.src = "//documentup.com/" + b, a ? c.src += "?config=" + encodeURIComponent(JSON.stringify(a)) + "&callback=callback" : c.src += "?callback=callback", document.getElementsByTagName("head")[0].appendChild(c)
}