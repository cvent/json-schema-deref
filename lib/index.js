...
function derefSchema(schema, baseSchema, pathToBase, options, fn) {
  ...
  if (refs && refs.length > 0) {
    async.eachSeries(refs, function (currRef, ascb) {
      ...
      var handleResult = function (newValue) {
        ...
        derefSchema(newValue, baseSchema, pathToBase.concat(currRef.path), options, function (err, newValueSchema) {
          if (!err) {
...
function deref(baseSchema, options, fn) {
  ...
  return derefSchema(baseSchema, baseSchema, '', options, fn)
}
